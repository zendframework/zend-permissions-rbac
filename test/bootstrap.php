<?php
/**
 * @link      http://github.com/zendframework/zend-permissions-rbac for the canonical source repository
...
if (class_exists('PHPUnit_Runner_Version', true)) {
    ...
    if ('@package_version@' !== $phpUnitVersion && version_compare($phpUnitVersion, '4.0.0', '<')) {
        echo 'This version of PHPUnit (' . PHPUnit_Runner_Version::id() . ') is not supported'
           . ' in the zend-permissions-rbac unit tests. Supported is version 4.0.0 or higher.'
